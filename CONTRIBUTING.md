# Contributing to aumos-legal-overlay
...
```
feat: add privilege log export to CSV endpoint
fix: resolve hash chain break on concurrent audit writes
refactor: extract privilege type validation into helper
docs: update API reference for legal hold endpoints
test: add integration tests for privilege check repository
